...
const basename = '/platforms'

const routers = createBrowserRouter([
    {
        path: basename,
        loader: () => replace(`${basename}/application-components/application`),
    },
    {
        path: `${basename}/application-components`,
        handle: {
            icon: 'AppstoreFilled',
            name: '应用组件管理',
        },
    ...
    {
        path: `${basename}/global-data-standard`,
        handle: {
            icon: 'DatabaseFilled',
            name: '全局数据标准',
        },
    ...
    {
        path: `${basename}/business-standard`,
        handle: {
            icon: 'ToolFilled',
            name: '业务标准定义',
        },
